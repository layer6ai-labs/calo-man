...
if args.load_dir:
    ...
    shared_cfg = {**shared_cfg, **dict(parse_config_arg(kv) for kv in args.shared_config)}
    shared_cfg["epl_module"] = None
    shared_cfg["epl_cfg"] = None
    shared_cfg["metric_kwargs"].update({"epl_module": None, "epl_cfg": None})
...
gae_cfg["label_dim"] = shared_cfg["label_dim"]
de_cfg["label_dim"] = shared_cfg["label_dim"]
